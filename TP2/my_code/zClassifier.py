...
def test(D):  
    ...
    for key in classifier_dict:
        ...
        acc = ClfScatter(D.data, myclassifier, dim1=0, dim2=1, title='classifier')#compute_accuracy(myclassifier, D, key) # Replace by a call to ClfScatter
